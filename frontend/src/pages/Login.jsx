      ...
      <main className="mx-auto flex max-w-7xl justify-center px-5 py-14">
        <section className="w-full max-w-md rounded-2xl border border-slate-200 bg-white p-7 shadow-sm sm:p-9">
          ...
          <h1 className="mt-2 font-[Manrope] text-3xl font-extrabold">
            Log in to CampusGigs
          </h1>
          <p className="mt-2 text-sm leading-6 text-slate-600">
            Find a task, lend a hand, and keep your campus moving.
          </p>
          ...
          <form onSubmit={submit} className="mt-7 space-y-5">
            <label className="block text-sm font-semibold">
              ...
              <input
                ...
                className="mt-1.5 w-full rounded-lg border border-slate-300 px-3 py-2.5 outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100"
